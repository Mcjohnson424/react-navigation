...
export default function BottomTabBar({
  ...
  const handleLayout = (e: LayoutChangeEvent) => {
    ...
    const customRendererStyles = typeof focusedOptions.renderBottomTabContent === "function" && styles.tabBarNoTopBorder;
    const topBorderWidth =
      // @ts-ignore
      StyleSheet.flatten([styles.tabBar, style, customRendererStyles])?.borderTopWidth;
  ...
  return (
    <Animated.View
      style={[
        ...
        style,
        typeof focusedOptions.renderBottomTabContent === "function" && styles.tabBarNoTopBorder,
      ]}
